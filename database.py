...
class _Users:
    ...
    def _validate_patch(self, data: dict) -> bool:
        try:
    ...
    def _validate_post(self, data: dict) -> bool:
        try:
    ...
    def update_user(self, id, data):
        if not self._validate_patch(data):
    ...
    def add_user(self, data):
        if not self._validate_post(data):
            return WRONG_REQUEST
